...
abstract class Native {
  Future<bool> testPedersenProof({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kTestPedersenProofConstMeta;
...
class NativeImpl extends FlutterRustBridgeBase<NativeWire> implements Native {
  ...
  Future<bool> testPedersenProof({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_test_pedersen_proof(port_),
        parseSuccessData: _wire2api_bool,
        constMeta: kTestPedersenProofConstMeta,
        argValues: [],
        hint: hint,
      ));
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_test_pedersen_proof(
    int port_,
  ) {
    return _wire_test_pedersen_proof(
      port_,
    );
  }

  late final _wire_test_pedersen_proofPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_test_pedersen_proof');
  late final _wire_test_pedersen_proof =
      _wire_test_pedersen_proofPtr.asFunction<void Function(int)>();
